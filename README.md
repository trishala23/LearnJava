...
| `basics.html` | JVM/JRE/JDK, variables, control flow, arrays, strings (pool, immutability, methods, StringBuilder), enums, classes & objects (constructors, `this`, instance vs static, `equals`/`hashCode`/`toString`), OOP pillars, exceptions, core collections |
