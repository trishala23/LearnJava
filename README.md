...
| `java8.html` | Lambdas (syntax forms, variable capture, worked problem statements you can edit and **really** compile/run in-browser), functional interfaces, Streams, method references, default/static interface methods, `Optional`, `java.time`, `CompletableFuture` |
